...
class `Example 6-11` {
    ...
    fun a_new_file_is_created_when_the_current_file_overflows(){
        ...
        every{fileSystemMock.readAllLines("""audits/audit_2.txt""")} returns mutableListOf("Peter; 2019-04-06T16:30:00","Jane; 2019-04-06T16:40:00","Jack; 2019-04-06T17:00:00")
